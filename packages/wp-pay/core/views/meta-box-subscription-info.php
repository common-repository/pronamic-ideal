...
<table class="form-table">
	...
	<tr>
		<th scope="row" rowspan="3">
			<?php esc_html_e( 'Customer action links', 'pronamic-ideal' ); ?>

			<span class="dashicons dashicons-editor-help pronamic-pay-tip" title="<?php echo esc_attr__( 'These actions links can be shared with the customer.', 'pronamic-ideal' ); ?>" tabindex="0"></span>
			...
			<div class="pronamic-pay-action-link">
				<div>
					...
					\printf(
						...
						\esc_attr( $url ),
						\esc_html__( 'Customer subscription cancel page →', 'pronamic-ideal' )
					);
				...
				<div>
					<span class="dashicons dashicons-editor-help pronamic-pay-tip" title="<?php echo \esc_attr__( 'This page can be shared with the customer and gives the customer the option to cancel this subscription.', 'pronamic-ideal' ); ?>" tabindex="0"></span>
				</div>

				<div class="pronamic-pay-action-link-clipboard">
					<button type="button" class="button button-small pronamic-pay-copy-url" data-clipboard-text="<?php echo \esc_url( $url ); ?>"><?php \esc_html_e( 'Copy URL to clipboard', 'pronamic-ideal' ); ?></button>
					<span class="success hidden" aria-hidden="true"><?php \esc_html_e( 'Copied!', 'pronamic-ideal' ); ?></span>
				</div>
			</div>
		</td>
	</tr>
			...
			<div class="pronamic-pay-action-link">
				<div>
					...
					\printf(
						'<a class="pronamic-pay-action-link-anchor" href="%s">%s</a>',
						\esc_attr( $url ),
						\esc_html__( 'Customer subscription renew page →', 'pronamic-ideal' )
					);
				...
				<div>
					<span class="dashicons dashicons-editor-help pronamic-pay-tip" title="<?php echo \esc_attr__( 'This page can be shared with the customer and gives the customer the option to (early) renew the subscription.', 'pronamic-ideal' ); ?>" tabindex="0"></span>
				</div>
			...
			<div class="pronamic-pay-action-link">
				<div>
					...
					\printf(
						'<a class="pronamic-pay-action-link-anchor" href="%s">%s</a>',
						\esc_attr( $url ),
						\esc_html__( 'Customer change payment method page →', 'pronamic-ideal' )
					);
